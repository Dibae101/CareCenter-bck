# Generated by Django 3.2.3 on 2021-06-10 03:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citizen', models.CharField(blank=True, choices=[('Y', 'Yes'), ('N', 'No')], max_length=50)),
                ...
                ('may_we_contact', models.CharField(blank=True, choices=[('Y', 'Yes'), ('N', 'No')], max_length=50)),
                ('address_1', models.CharField(blank=True, max_length=100)),
                ('city_1', models.CharField(blank=True, max_length=100)),
                ('state_1', models.CharField(blank=True, choices=[('AL', 'Alabama'), ('AK', 'Alaska'), ('AZ', 'Arizona'), ('AR', 'Arkansas'), ('CA', 'California'), ('CO', 'Colorado'), ('CT', 'Connecticut'), ('DC', 'Washington DC'), ('DE', 'Deleware'), ('FL', 'Florida'), ('GA', 'Georgia'), ('HI', 'Hawaii'), ('ID', 'Idaho'), ('IL', 'Illinios'), ('IN', 'Indiana'), ('IA', 'Iowa'), ('KS', 'Kansas'), ('KY', 'Kentucky'), ('LA', 'Louisiana'), ('ME', 'Maine'), ('MD', 'Maryland'), ('MA', 'Massachusetts'), ('MI', 'Michigan'), ('MN', 'Minnesota'), ('MS', 'Mississippi'), ('MO', 'Missouri'), ('MT', 'Montana'), ('NE', 'Nebraska'), ('NV', 'Nevada'), ('NH', 'New Hampshire'), ('NJ', 'New Jersey'), ('NM', 'New Mexico'), ('NY', 'New York'), ('NC', 'North Carolina'), ('ND', 'North Dakota'), ('OH', 'Ohio'), ('OK', 'Oklahoma'), ('OR', 'Oregon'), ('PA', 'Pennsylvania'), ('RI', 'Rhode Island'), ('SC', 'South Carolina'), ('SD', 'South Dakota'), ('TN', 'Tennessee'), ('TX', 'Texas'), ('UT', 'Utah'), ('VT', 'Vermont'), ('VA', 'Virgina'), ('WA', 'Washington'), ('WV', 'West Virginia'), ('WI', 'Wisconsin'), ('WY', 'Wyoming')], max_length=50)),
                ('zip_code_1', models.PositiveIntegerField(blank=True)),
                ('position', models.CharField(blank=True, max_length=100)),
                ('hours_available', models.CharField(blank=True, choices=[('Sun-Sat', 'Any Hours Sun-Sat'), ('Mon-Fri', 'Any Hours Mon-Fri'), ('Mornings', 'Mornings Only'), ('Evenings', 'Evenings Only'), ('Night', 'Night Shifts'), ('Weekends', 'Weekends Only'), ('Other', 'Others')], max_length=50)),
                ...
                ('engage_other', models.CharField(blank=True, choices=[('Y', 'Yes'), ('N', 'No')], max_length=50)),
                ('further_study', models.CharField(blank=True, choices=[('Y', 'Yes'), ('N', 'No')], max_length=50)),
